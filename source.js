...
<div class="form-check">
  <input  class="form-check-input"  type="checkbox"  value="Pizza"  id="Pizza"  name="option"/>
  <label class="form-check-label" for="Pizza"> Pizza </label>
</div>
<div class="form-check">
  <input  class="form-check-input"  type="checkbox"  value=Burger"  id="Burger"  name="option" />
...
<div class="form-check">
    <input  class="form-check-input"  type="checkbox"  value="chat"  id="chat"  name="option" />
